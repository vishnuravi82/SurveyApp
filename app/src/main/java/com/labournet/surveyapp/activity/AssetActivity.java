...
public class AssetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String[] asset = {"House ", "Drinking water source ","Bicycle / Two Wheeler / Four wheeler","Refrigerator","TV","others"};
    ...
    private void Assign() {
        ...
        ;
        sp=findViewById(R.id.sp_asset);
        submit=findViewById(R.id.btn_submit);;

        ArrayAdapter<String> adp= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, asset);
    ...
    private void login() {
        startActivity(new Intent(AssetActivity.this, LoanActivity.class));
