...
public class LoanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String[] loan = {"Bank ", "SHG","Private persons","Total indebtedness"};
    ...
    private void Assign() {
        ...
        ;
        sp=findViewById(R.id.sp_loan);
        submit=findViewById(R.id.btn_submit);;


        ArrayAdapter<String> adp= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, loan);
    ...
    private void login() {
        startActivity(new Intent(LoanActivity.this, MembershipActivity.class));
