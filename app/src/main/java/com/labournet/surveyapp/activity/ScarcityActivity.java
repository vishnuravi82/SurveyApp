...
public class ScarcityActivity extends AppCompatActivity implements View.OnClickListener {
    Spinner sp,sp1;
    private AppCompatButton submit;


    String[] gender = {"Male", "Female"};
    String[] scarcity = {"Food grains", "Wage work ","Fodder","Firewood","others"};
    String[] purchae = {"Yes", "No"};
    String[] residence = {"Residence in village", "no_residence"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.scarcity_activity);
        setupActionBar();
        Assign();
    ...
    private void Assign() {
        ...
        ;
        sp=findViewById(R.id.sp_scrcity);
        sp1=findViewById(R.id.sp_purchase);
        submit=findViewById(R.id.btn_submit);;

        ArrayAdapter<String> adp= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, scarcity);
        adp.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sp.setAdapter(adp);
        ArrayAdapter<String> adp1= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, purchae);
    ...
    private void login() {
        startActivity(new Intent(ScarcityActivity.this, AssetActivity.class));
