...
public class LandDetailActivity extends AppCompatActivity implements View.OnClickListener {
    Spinner sp;
    private AppCompatButton submit;

    String[] gender = {"Male", "Female"};
    String[] land = {"Rain fed", "Irrigated","Fallow","Horticulture","Waste land"};
    ...
    private void Assign() {
        ...
        ;
        sp=findViewById(R.id.sp_land);
        submit=findViewById(R.id.btn_submit);;


        ArrayAdapter<String> adp= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, land);
    ...
    private void login() {
        startActivity(new Intent(LandDetailActivity.this, SourceDetailActivity.class));
