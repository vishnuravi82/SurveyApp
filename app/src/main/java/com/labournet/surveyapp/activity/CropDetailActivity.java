...
public class CropDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String[] crop = {"Paddy ", "Maize ","Cotton","Jowar","Ground nut","Pulses","Others","total"};
    String[] disability = {"yes", "no"};
    String[] residence = {"Residence in village", "no_residence"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.crops_activity);
        setupActionBar();
        Assign();
    ...
    private void Assign() {
        ...
        ;
        sp=findViewById(R.id.sp_crop);
        submit=findViewById(R.id.btn_submit);;

        ArrayAdapter<String> adp= new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, crop);
    ...
    private void login() {
        startActivity(new Intent(CropDetailActivity.this, AgricultureActivity.class));
